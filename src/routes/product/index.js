...
router.get(
  "/search/:keySearch",
  asyncHandler(productController.getSearchListProduct)
);
...
router.post(
  "/publish/:id",
  asyncHandler(productController.setPublishedProductInShop)
);
//  handle set unpublished product
router.post(
  "/unpublish/:id",
  asyncHandler(productController.setUnPublishedProductInShop)
);
